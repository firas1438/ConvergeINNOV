  ...
  return (
    <section id="services" className="relative pt-32 pb-12 px-4 max-w-screen-xl mx-auto" style={{ minHeight: "600px" }}>
      ...
      <div className="relative z-10 flex flex-col items-center">
        {/* header */}
        <motion.div initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.6, ease: "easeOut" }} className="flex flex-col gap-3 justify-center items-center mb-10 max-w-xl text-center">
