...
export default function About() {
  ...
  return (
    <motion.section id="about" initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}
    ...
    >
      ...
      <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
        {/* Left Content */}
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, type: "spring", bounce: 0.2 }} className="flex flex-col gap-6 px-4">
          {/* introduction */}
          <p className="text-foreground-600 text-[1.05rem] mb-2">
            {intro}
          </p>
