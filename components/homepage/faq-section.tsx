...
export default function Faq() {
  ...
  return (
    <motion.section id="faq" initial={{ y: 20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }}
    ...
    >
      ...
      <div className="flex w-full max-w-5xl">
        <Accordion
          fullWidth selectionMode="multiple" variant="splitted" className="gap-y-3"
          motionProps={{ variants: { enter: { y: 0, opacity: 1, height: "auto", transition: { height: { type: "spring", stiffness: 500, damping: 30, duration: 0.5,}, opacity: { easings: "ease", duration: 0.5 }, },}, exit: { y: -10, opacity: 0, height: 0, transition: { height: { easings: "ease", duration: 0.25 }, opacity: { easings: "ease", duration: 0.25 }, },}, },}}
        >
